  ...
  <div>
    ...
    <div class='scroll'>
      <ul class="users_wrap" id="users_wrap">
        <li v-for='user in common_user' :key='user.key'>
          <p>
    ...
    <div class='scroll2'>
      <ul class="users_wrap2" id="users_wrap2">
        <li v-for='user in bonus_user' :key='user.key'>
          <img v-bind:src='user.headpic' />
          <span>{{user.name}}</span>
          <span>{{user.desc}}</span>
        </li>
    ...
    <div class="videoWrap">
      <video id="videoElement" width="100%" height="100%" x-webkit-airplay="true" playsinline="true" src="http://file2.sythealth.com/plancenter/veido/v2/ad/ota_20170612/1499832572931/ota_20170612.mp4">
      </video>
      <img class="videoPlay" @click='this.videoPlay' src="./img/playBtn.png" />
      <div class="videoPause" @click='this.videoPause'>&times;</div>
    </div>
...
export default {
  ...
  methods: {
    ...
    videoPlay() {
      ...
      document.querySelectorAll('.videoPause')[0].style.top = '6rem'
      document.querySelectorAll('.videoPause')[0].style.right = '2rem'
      document.querySelectorAll('.videoPause')[0].style.fontSize = '3rem'
      document.querySelectorAll('.videoPause')[0].style.zIndex = '999'
