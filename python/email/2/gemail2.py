...
def ShowInfo():  
	# url = 'http://test.chazuomba.com:8080/iserver/app/queryMemberListByCourseIdForEmail'
	# data = {'courseId': '1955'} 
	...
	email_l = [
			...
			{u'name': u'\u8bb8\u6587\u8273', u'email': u'2227006164@qq.com'},
...
def mailData(userName,userEmail,sender):
	...
	im = Image.open("zzl.png").resize((750, 1333),Image.ANTIALIAS)
