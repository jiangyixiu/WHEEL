	...
	$.ajax({
		...
		success: function(data){
			if(data.status == '200' || data.status == '600'){ //报名成功 || 已报名
				...
				var url = encodeURI("http://www.chazuomba.com/files/webApp/giftClass/audit.html?audit="+ audit +"&unionId="+ userInfo.unionid + "&orderCode=" + orderCode + "&openid=" + userInfo.openid + "&courseId=" + userInfo.courseId + "&type=0" + "&courseType=0");
